...
const Home = () => {
  ...
  return (
    <main>
      <Navbar/>
      <div className="page px-4 sm:px-6 lg:px-10">
        {/* Hero Section */}
        <div className="relative w-full bg-white">
          <div className='flex flex-col md:flex-row p-0 m-0 items-center z-10'>  
            <Image   
              className='z-10 unoptimized w-full md:w-1/2 object-cover'
              src="/teach.gif"   
              alt="bg-image"   
              width={1000}   
              height={1000}   
            />  
            <div className='flex flex-col justify-center items-center w-full md:w-1/2 space-y-4 px-4'> 
              <Image 
                className="object-contain p-0 mb-8 md:mb-16 w-1/2 md:w-auto" 
                src="/logo.png" 
                alt="SchoolSync Logo" 
                width={200} 
                height={50} 
                ...
                {[...Array(3).keys()].map(idx => (
                  <div key={idx} className="group transform hover:scale-105 transition-all">
                    <div className={`p-4 md:p-6 rounded-xl shadow-lg text-center ${idx % 2 ? 'bg-black' : 'bg-[#3d5a80]'} hover:shadow-2xl`}>
                      ...
                      <p className="mt-2 text-white text-sm md:text-base">Lessons</p>
                    </div>
                  </div>
                ))}
              </div>
              ...
              {[
                ...
                >
                  ...
                  <div className="text-center md:text-left space-y-2 w-full">
                    ...
                    <h2 className="text-xs md:text-sm text-gray-600">Beginner Level</h2>
                    <h1 className="font-medium text-gray-700 text-sm md:text-base">By {course.instructor}</h1>
        ...
        <h1 className="text-2xl md:text-4xl font-bold text-center mb-8">Our Mentors</h1>
        <div className="relative w-full bg-white">
          <div className="absolute inset-0">
            <svg viewBox="0 0 500 200" className="w-full m-0">
              <path d="M 0 30 C 150 100 280 0 500 20 L 500 0 L 0 0" fill="#3d5a80"></path>
            </svg>
          </div>

          <div className="relative z-10 flex justify-center pt-8">
            <div className="w-full md:w-4/5 grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-5 gap-4 md:gap-8">
                ...
                >
                  <div className="relative z-10 p-4 md:p-6">
                    <img
                      src={mentor.img}
                      alt={mentor.name}
                      className="shadow-lg rounded-full w-16 h-16 md:w-24 md:h-24 mx-auto mb-2 md:mb-4"
                    />
                    <h2 className="text-sm md:text-xl font-semibold text-gray-800">{mentor.name}</h2>
                  </div>
                </div>
              ))}
            </div>
